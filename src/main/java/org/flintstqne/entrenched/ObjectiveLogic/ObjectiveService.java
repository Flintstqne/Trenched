...
public final class ObjectiveService {
     ...
     */
    public record PlantedExplosiveInfo(
            String regionId,
            int objectiveId,
            UUID planterUuid,
            String planterTeam,
     ...
     */
    public record IntelCarrierInfo(
     ...
     */
    public record HoldGroundPlayerData(String regionId, int x, int z, String team) {}

    @FunctionalInterface
    public interface ObjectiveCompletionCallback {
        void onObjectiveCompleted(RegionObjective objective, UUID playerUuid, String team);
    }

    @FunctionalInterface
    public interface ObjectiveSpawnCallback {
    ...
    public ObjectiveService(JavaPlugin plugin, ObjectiveDb db, RoundService roundService,
